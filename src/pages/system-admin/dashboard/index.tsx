                ...
                <div className={`flex-1 flex flex-col overflow-hidden ${isOpen ? 'lg:ml-64' : ''}`}>
                    ...
                    <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100">
                        <div className="container mx-auto px-6 py-8">
                            <div className="mb-8">
                                <h1 className="text-2xl font-bold mb-2">Xin chào quản trị viên</h1>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                                ...
                                />
                                <StatsCard
                                    title="Tổng số việc làm được đăng"
                                    value={18}
                                    className="bg-[#56CDAD]"
                                />
                                <StatsCard
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-1 gap-6 mb-8">
                                <BarChart
                                    data={accountData}
                                    title="Thống kê đăng ký tài khoản"
                                    categoryType="trường học"
                                />
                                <BarChart
                                    data={jobData}
                                    title="Thống kê việc làm được đăng tuyển"
                                    categoryType="chuyên ngành"
                                />
                                <PieChart
                                    data={matchingData}
                                    title="Biểu đồ tỉ lệ matching"
                                />
                            </div>
                        </div>
                    </main>
